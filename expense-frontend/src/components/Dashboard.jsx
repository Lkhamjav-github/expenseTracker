            ...
            <div className='py-8 px-[120px] flex gap-6 ' >
                ...
                <div className='rounded-xl bg-white  w-[384px]'>
                    ...
                    <div className='pt-5 px-6 pb-6'>
                        <h1 className='text-4xl pb-1 font-semibold'>1,200,000$</h1>
                        <p className='text-[#64748B] text-lg font-normal'>Your income Amount</p>
